const weatherCurrentLocation = async () => {
  try {
    const respuesta = await fetch(
      `https://api.openweathermap.org/data/2.5/weather?lat=${localStorage.getItem("latitud")}&lon=${localStorage.getItem("longitud")}&units=metric&appid=be5235333d3813f99d5ad786ba5223ca`
    );
